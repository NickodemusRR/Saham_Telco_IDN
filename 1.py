...
excl = pd.read_csv('./datasets/EXCL.JK.csv', index_col=False, parse_dates=['Date'])
fren = pd.read_csv('./datasets/FREN.JK.csv', index_col=False, parse_dates=['Date'])
isat = pd.read_csv('./datasets/ISAT.JK.csv', index_col=False, parse_dates=['Date'])
tlkm = pd.read_csv('./datasets/TLKM.JK.csv', index_col=False, parse_dates=['Date'])
...
plt.xticks(ticks, rotation=35, fontsize=9)
plt.show()